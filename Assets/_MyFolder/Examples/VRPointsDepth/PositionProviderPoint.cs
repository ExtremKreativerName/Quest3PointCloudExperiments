...
public class PositionProviderPoint : MonoBehaviour
{
    ...
    {  
        //  (float == 4)
        _graphicsBufferPoints = new GraphicsBuffer(GraphicsBuffer.Target.Structured,amount, sizeof(float)*4 ); // makes the assumption that amount is not a stupid number, just dont be an idiot
    }
