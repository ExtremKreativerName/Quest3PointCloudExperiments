...
public class PositionProviderVFX : MonoBehaviour
{
    ...
    void SetShaderProperties()
    {
        ...
        _visualEffect.SetUInt("ParticleCount", (uint)amount);
    ...
    void Update()
    {
        ...
        if (_graphicsBufferPoints != null)
        {
            // Set the GraphicsBuffer to the VisualEffect
            _visualEffect.SetGraphicsBuffer("_graphicsBufferPoints", _graphicsBufferPoints);
